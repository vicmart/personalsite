...
$('.panel').hover(
	function(){
		...
		$("#" + $(this).attr('id') + "-movies").css("-webkit-animation-duration", "0.5s");
		$("#" + $(this).attr('id') + "-movies").css("-moz-animation-duration", "0.5s");
		$("#" + $(this).attr('id') + "-movies").css("-o-animation-duration", "0.5s");
		$("#" + $(this).attr('id') + "-movies").css("-ms-animation-duration", "0.5s");
		$("#" + $(this).attr('id') + "-movies").css("animation-duration", "0.5s");

		$("#" + $(this).attr('id') + "-movies").css("-webkit-animation-delay", "0.8s");
		$("#" + $(this).attr('id') + "-movies").css("-moz-animation-delay", "0.8s");
		$("#" + $(this).attr('id') + "-movies").css("-o-animation-delay", "0.8s");
		$("#" + $(this).attr('id') + "-movies").css("-ms-animation-delay", "0.8s");
		$("#" + $(this).attr('id') + "-movies").css("animation-delay", "0.8s");
